      ...
      <div className="flex flex-row p-5 justify-between w-[90vw] gap-5 md:gap-8 ">
        ...
        <div className="flex flex-row gap-4 md:gap-8">
          <div className="flex flex-row-reverse md:flex-row bg-secondary rounded-lg p-1 gap-1 max-h-11">
            {tools.map((item, index) => (
              <button
                title={item.title}
                key={index}
                className={`flex text-xl flex-col items-center rounded-lg justify-center p-2 border-black  cursor-pointer font-extrabold ${
                  item.value === tool
                    ? "bg-tertiary text-primary"
                    : "text-[#A6ABBD] hover:bg-slate-600"
                }`}
          ...
          <div className="flex flex-row bg-secondary rounded-lg p-1 gap-1 max-h-11">
            <button
              onClick={undo}
              className="flex flex-col text-xl items-center rounded-lg justify-center p-2 border-black  cursor-pointer font-extrabold text-[#A6ABBD] hover:bg-slate-600 active:text-primary active:bg-tertiary"
            >
              <LuUndo2 />
            </button>
            ...
            <button
              onClick={redo}
              className="flex text-xl flex-col items-center rounded-lg justify-center p-2 border-black  cursor-pointer font-extrabold text-[#A6ABBD] hover:bg-slate-600 active:text-primary active:bg-tertiary"
            >
              <LuRedo2 />
            </button>
          </div>
